...
// Key Get Result baiy given key string.
...
// Message Set Result message baiy string or format string with args
...
// ErrorMap Return the errors mapped baiy key.
